...
public class CitaVacunacion {
    ...
    public CitaVacunacion(int CodCita, Ciudadano persona, int codRefuerzo, String FechaHoraCita, int centroVacunacion, LocalDateTime fechaHoraColoca, Vacuna dosis, boolean citaEstado) {
    ...
    public CitaVacunacion(int CodCita, Ciudadano persona, int dni, int codRefuerzo, String FechaHoraCita, int centroVacunacion, LocalDateTime fechaHoraColoca, Vacuna dosis, boolean citaEstado) {
        this.CodCita = CodCita;
        this.persona = persona;
        this.dni = dni;
        this.codRefuerzo = codRefuerzo;
